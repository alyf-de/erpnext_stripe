...
from erpnext_stripe.utils import get_valid_contact_email, log_skipped_contact_email
...
def run(stripe_customer: "StripeCustomer"):
	...
	customer_doc.customer_name = stripe_customer.name or stripe_customer.email or stripe_customer.id
	...
	if valid_email or stripe_customer.phone:
